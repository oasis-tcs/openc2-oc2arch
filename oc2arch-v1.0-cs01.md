...
For complete copyright information please see the full Notices section in [Appendix G](#appendix-g-notices) below.
...
* **OpenC2 Actuator Profiles** specify the subset of the OpenC2
  ...
  elements that are relevant and/or unique to that function.
...
functions, and their corresponding APs. The cybersecurity
